...
- **001_initial_migration**: 초기 테이블 생성 (18개 테이블)
  - analysts, companies, markets
  - reports, report_sections, extracted_texts, extracted_tables, extracted_images
  - predictions, actual_results
  - evaluations, evaluation_scores, evaluation_reports
  - scorecards, awards
  - data_sources, data_collection_logs
  - prompt_templates
